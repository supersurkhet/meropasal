			...
			{#each items as item, i}
				...
				<div class="grid grid-cols-[1fr_100px_120px_100px_auto] items-center gap-2 border-b border-zinc-100 px-3 py-2 last:border-b-0 dark:border-zinc-800">
					...
					<Input
						...
						placeholder="0"
						min="1"
						class="h-9 text-sm font-mono border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900 {fieldErrors[`items.${i}.quantity`] ? 'border-red-400 ring-1 ring-red-400/30' : ''}"
					/>
